...
namespace DoomEngine.Doom.Info
{
	...
	public static partial class DoomInfo
    {
        ...
        public static readonly MobjStateDef[] States = new MobjStateDef[]
        {
            ...
            new MobjStateDef(1, Sprite.SHTG, 4, 0, DoomInfo.pa.Light0, null, MobjState.Null, 0, 0), // State.Lightdone
            new MobjStateDef(2, Sprite.PUNG, 0, 1, DoomInfo.pa.WeaponReady, null, MobjState.Punch, 0, 0), // State.Punch
            ...
            new MobjStateDef(10, Sprite.PISG, 0, 1, DoomInfo.pa.WeaponReady, null, MobjState.Pistol, 0, 0), // State.Pistol
            ...
            new MobjStateDef(18, Sprite.SHTG, 0, 1, DoomInfo.pa.WeaponReady, null, MobjState.Sgun, 0, 0), // State.Sgun
            ...
            new MobjStateDef(29, Sprite.SHTG, 0, 7, DoomInfo.pa.ReFire, null, MobjState.Sgun, 0, 0), // State.Sgun9
            new MobjStateDef(30, Sprite.SHTF, 32768, 4, DoomInfo.pa.Light1, null, MobjState.Sgunflash2, 0, 0), // State.Sgunflash1
            new MobjStateDef(31, Sprite.SHTF, 32769, 3, DoomInfo.pa.Light2, null, MobjState.Lightdone, 0, 0), // State.Sgunflash2
            new MobjStateDef(32, Sprite.SHT2, 0, 1, DoomInfo.pa.WeaponReady, null, MobjState.Dsgun, 0, 0), // State.Dsgun
            ...
            new MobjStateDef(41, Sprite.SHT2, 5, 7, DoomInfo.pa.LoadShotgun2, null, MobjState.Dsgun8, 0, 0), // State.Dsgun7
            new MobjStateDef(42, Sprite.SHT2, 6, 6, null, null, MobjState.Dsgun9, 0, 0), // State.Dsgun8
            new MobjStateDef(43, Sprite.SHT2, 7, 6, DoomInfo.pa.CloseShotgun2, null, MobjState.Dsgun10, 0, 0), // State.Dsgun9
            new MobjStateDef(44, Sprite.SHT2, 0, 5, DoomInfo.pa.ReFire, null, MobjState.Dsgun, 0, 0), // State.Dsgun10
            ...
            new MobjStateDef(47, Sprite.SHT2, 32776, 5, DoomInfo.pa.Light1, null, MobjState.Dsgunflash2, 0, 0), // State.Dsgunflash1
            new MobjStateDef(48, Sprite.SHT2, 32777, 4, DoomInfo.pa.Light2, null, MobjState.Lightdone, 0, 0), // State.Dsgunflash2
            ...
            new MobjStateDef(57, Sprite.MISG, 0, 1, DoomInfo.pa.WeaponReady, null, MobjState.Missile, 0, 0), // State.Missile
            ...
            new MobjStateDef(65, Sprite.MISF, 32770, 4, DoomInfo.pa.Light2, null, MobjState.Missileflash4, 0, 0), // State.Missileflash3
            new MobjStateDef(66, Sprite.MISF, 32771, 4, DoomInfo.pa.Light2, null, MobjState.Lightdone, 0, 0), // State.Missileflash4
            new MobjStateDef(67, Sprite.SAWG, 2, 4, DoomInfo.pa.WeaponReady, null, MobjState.Sawb, 0, 0), // State.Saw
            ...
            new MobjStateDef(81, Sprite.BFGG, 0, 1, DoomInfo.pa.WeaponReady, null, MobjState.Bfg, 0, 0), // State.Bfg
            new MobjStateDef(82, Sprite.BFGG, 0, 1, DoomInfo.pa.Lower, null, MobjState.Bfgdown, 0, 0), // State.Bfgdown
            ...
            new MobjStateDef(119, Sprite.BFE1, 32770, 8, null, DoomInfo.ma.BFGSpray, MobjState.Bfgland4, 0, 0), // State.Bfgland3
            ...
            new MobjStateDef(127, Sprite.MISL, 32769, 8, null, DoomInfo.ma.Explode, MobjState.Explode2, 0, 0), // State.Explode1
            ...
            new MobjStateDef(157, Sprite.PLAY, 6, 4, null, DoomInfo.ma.Pain, MobjState.Play, 0, 0), // State.PlayPain2
            new MobjStateDef(158, Sprite.PLAY, 7, 10, null, null, MobjState.PlayDie2, 0, 0), // State.PlayDie1
            new MobjStateDef(159, Sprite.PLAY, 8, 10, null, DoomInfo.ma.PlayerScream, MobjState.PlayDie3, 0, 0), // State.PlayDie2
            new MobjStateDef(160, Sprite.PLAY, 9, 10, null, DoomInfo.ma.Fall, MobjState.PlayDie4, 0, 0), // State.PlayDie3
            ...
            new MobjStateDef(166, Sprite.PLAY, 15, 5, null, DoomInfo.ma.XScream, MobjState.PlayXdie3, 0, 0), // State.PlayXdie2
            new MobjStateDef(167, Sprite.PLAY, 16, 5, null, DoomInfo.ma.Fall, MobjState.PlayXdie4, 0, 0), // State.PlayXdie3
            ...
            new MobjStateDef(174, Sprite.POSS, 0, 10, null, DoomInfo.ma.Look, MobjState.PossStnd2, 0, 0), // State.PossStnd
            new MobjStateDef(175, Sprite.POSS, 1, 10, null, DoomInfo.ma.Look, MobjState.PossStnd, 0, 0), // State.PossStnd2
            new MobjStateDef(176, Sprite.POSS, 0, 4, null, DoomInfo.ma.Chase, MobjState.PossRun2, 0, 0), // State.PossRun1
            new MobjStateDef(177, Sprite.POSS, 0, 4, null, DoomInfo.ma.Chase, MobjState.PossRun3, 0, 0), // State.PossRun2
            new MobjStateDef(178, Sprite.POSS, 1, 4, null, DoomInfo.ma.Chase, MobjState.PossRun4, 0, 0), // State.PossRun3
            new MobjStateDef(179, Sprite.POSS, 1, 4, null, DoomInfo.ma.Chase, MobjState.PossRun5, 0, 0), // State.PossRun4
            new MobjStateDef(180, Sprite.POSS, 2, 4, null, DoomInfo.ma.Chase, MobjState.PossRun6, 0, 0), // State.PossRun5
            new MobjStateDef(181, Sprite.POSS, 2, 4, null, DoomInfo.ma.Chase, MobjState.PossRun7, 0, 0), // State.PossRun6
            new MobjStateDef(182, Sprite.POSS, 3, 4, null, DoomInfo.ma.Chase, MobjState.PossRun8, 0, 0), // State.PossRun7
            new MobjStateDef(183, Sprite.POSS, 3, 4, null, DoomInfo.ma.Chase, MobjState.PossRun1, 0, 0), // State.PossRun8
            new MobjStateDef(184, Sprite.POSS, 4, 10, null, DoomInfo.ma.FaceTarget, MobjState.PossAtk2, 0, 0), // State.PossAtk1
            new MobjStateDef(185, Sprite.POSS, 5, 8, null, DoomInfo.ma.PosAttack, MobjState.PossAtk3, 0, 0), // State.PossAtk2
            ...
            new MobjStateDef(188, Sprite.POSS, 6, 3, null, DoomInfo.ma.Pain, MobjState.PossRun1, 0, 0), // State.PossPain2
            new MobjStateDef(189, Sprite.POSS, 7, 5, null, null, MobjState.PossDie2, 0, 0), // State.PossDie1
            new MobjStateDef(190, Sprite.POSS, 8, 5, null, DoomInfo.ma.Scream, MobjState.PossDie3, 0, 0), // State.PossDie2
            new MobjStateDef(191, Sprite.POSS, 9, 5, null, DoomInfo.ma.Fall, MobjState.PossDie4, 0, 0), // State.PossDie3
            ...
            new MobjStateDef(195, Sprite.POSS, 13, 5, null, DoomInfo.ma.XScream, MobjState.PossXdie3, 0, 0), // State.PossXdie2
            new MobjStateDef(196, Sprite.POSS, 14, 5, null, DoomInfo.ma.Fall, MobjState.PossXdie4, 0, 0), // State.PossXdie3
            ...
            new MobjStateDef(207, Sprite.SPOS, 0, 10, null, DoomInfo.ma.Look, MobjState.SposStnd2, 0, 0), // State.SposStnd
            new MobjStateDef(208, Sprite.SPOS, 1, 10, null, DoomInfo.ma.Look, MobjState.SposStnd, 0, 0), // State.SposStnd2
            new MobjStateDef(209, Sprite.SPOS, 0, 3, null, DoomInfo.ma.Chase, MobjState.SposRun2, 0, 0), // State.SposRun1
            new MobjStateDef(210, Sprite.SPOS, 0, 3, null, DoomInfo.ma.Chase, MobjState.SposRun3, 0, 0), // State.SposRun2
            new MobjStateDef(211, Sprite.SPOS, 1, 3, null, DoomInfo.ma.Chase, MobjState.SposRun4, 0, 0), // State.SposRun3
            new MobjStateDef(212, Sprite.SPOS, 1, 3, null, DoomInfo.ma.Chase, MobjState.SposRun5, 0, 0), // State.SposRun4
            new MobjStateDef(213, Sprite.SPOS, 2, 3, null, DoomInfo.ma.Chase, MobjState.SposRun6, 0, 0), // State.SposRun5
            new MobjStateDef(214, Sprite.SPOS, 2, 3, null, DoomInfo.ma.Chase, MobjState.SposRun7, 0, 0), // State.SposRun6
            new MobjStateDef(215, Sprite.SPOS, 3, 3, null, DoomInfo.ma.Chase, MobjState.SposRun8, 0, 0), // State.SposRun7
            new MobjStateDef(216, Sprite.SPOS, 3, 3, null, DoomInfo.ma.Chase, MobjState.SposRun1, 0, 0), // State.SposRun8
            new MobjStateDef(217, Sprite.SPOS, 4, 10, null, DoomInfo.ma.FaceTarget, MobjState.SposAtk2, 0, 0), // State.SposAtk1
            new MobjStateDef(218, Sprite.SPOS, 32773, 10, null, DoomInfo.ma.SPosAttack, MobjState.SposAtk3, 0, 0), // State.SposAtk2
            ...
            new MobjStateDef(221, Sprite.SPOS, 6, 3, null, DoomInfo.ma.Pain, MobjState.SposRun1, 0, 0), // State.SposPain2
            new MobjStateDef(222, Sprite.SPOS, 7, 5, null, null, MobjState.SposDie2, 0, 0), // State.SposDie1
            new MobjStateDef(223, Sprite.SPOS, 8, 5, null, DoomInfo.ma.Scream, MobjState.SposDie3, 0, 0), // State.SposDie2
            new MobjStateDef(224, Sprite.SPOS, 9, 5, null, DoomInfo.ma.Fall, MobjState.SposDie4, 0, 0), // State.SposDie3
            ...
            new MobjStateDef(228, Sprite.SPOS, 13, 5, null, DoomInfo.ma.XScream, MobjState.SposXdie3, 0, 0), // State.SposXdie2
            new MobjStateDef(229, Sprite.SPOS, 14, 5, null, DoomInfo.ma.Fall, MobjState.SposXdie4, 0, 0), // State.SposXdie3
            ...
            new MobjStateDef(241, Sprite.VILE, 0, 10, null, DoomInfo.ma.Look, MobjState.VileStnd2, 0, 0), // State.VileStnd
            new MobjStateDef(242, Sprite.VILE, 1, 10, null, DoomInfo.ma.Look, MobjState.VileStnd, 0, 0), // State.VileStnd2
            new MobjStateDef(243, Sprite.VILE, 0, 2, null, DoomInfo.ma.VileChase, MobjState.VileRun2, 0, 0), // State.VileRun1
            new MobjStateDef(244, Sprite.VILE, 0, 2, null, DoomInfo.ma.VileChase, MobjState.VileRun3, 0, 0), // State.VileRun2
            new MobjStateDef(245, Sprite.VILE, 1, 2, null, DoomInfo.ma.VileChase, MobjState.VileRun4, 0, 0), // State.VileRun3
            new MobjStateDef(246, Sprite.VILE, 1, 2, null, DoomInfo.ma.VileChase, MobjState.VileRun5, 0, 0), // State.VileRun4
            new MobjStateDef(247, Sprite.VILE, 2, 2, null, DoomInfo.ma.VileChase, MobjState.VileRun6, 0, 0), // State.VileRun5
            new MobjStateDef(248, Sprite.VILE, 2, 2, null, DoomInfo.ma.VileChase, MobjState.VileRun7, 0, 0), // State.VileRun6
            new MobjStateDef(249, Sprite.VILE, 3, 2, null, DoomInfo.ma.VileChase, MobjState.VileRun8, 0, 0), // State.VileRun7
            new MobjStateDef(250, Sprite.VILE, 3, 2, null, DoomInfo.ma.VileChase, MobjState.VileRun9, 0, 0), // State.VileRun8
            new MobjStateDef(251, Sprite.VILE, 4, 2, null, DoomInfo.ma.VileChase, MobjState.VileRun10, 0, 0), // State.VileRun9
            new MobjStateDef(252, Sprite.VILE, 4, 2, null, DoomInfo.ma.VileChase, MobjState.VileRun11, 0, 0), // State.VileRun10
            new MobjStateDef(253, Sprite.VILE, 5, 2, null, DoomInfo.ma.VileChase, MobjState.VileRun12, 0, 0), // State.VileRun11
            new MobjStateDef(254, Sprite.VILE, 5, 2, null, DoomInfo.ma.VileChase, MobjState.VileRun1, 0, 0), // State.VileRun12
            new MobjStateDef(255, Sprite.VILE, 32774, 0, null, DoomInfo.ma.VileStart, MobjState.VileAtk2, 0, 0), // State.VileAtk1
            new MobjStateDef(256, Sprite.VILE, 32774, 10, null, DoomInfo.ma.FaceTarget, MobjState.VileAtk3, 0, 0), // State.VileAtk2
            new MobjStateDef(257, Sprite.VILE, 32775, 8, null, DoomInfo.ma.VileTarget, MobjState.VileAtk4, 0, 0), // State.VileAtk3
            new MobjStateDef(258, Sprite.VILE, 32776, 8, null, DoomInfo.ma.FaceTarget, MobjState.VileAtk5, 0, 0), // State.VileAtk4
            new MobjStateDef(259, Sprite.VILE, 32777, 8, null, DoomInfo.ma.FaceTarget, MobjState.VileAtk6, 0, 0), // State.VileAtk5
            new MobjStateDef(260, Sprite.VILE, 32778, 8, null, DoomInfo.ma.FaceTarget, MobjState.VileAtk7, 0, 0), // State.VileAtk6
            new MobjStateDef(261, Sprite.VILE, 32779, 8, null, DoomInfo.ma.FaceTarget, MobjState.VileAtk8, 0, 0), // State.VileAtk7
            new MobjStateDef(262, Sprite.VILE, 32780, 8, null, DoomInfo.ma.FaceTarget, MobjState.VileAtk9, 0, 0), // State.VileAtk8
            new MobjStateDef(263, Sprite.VILE, 32781, 8, null, DoomInfo.ma.FaceTarget, MobjState.VileAtk10, 0, 0), // State.VileAtk9
            new MobjStateDef(264, Sprite.VILE, 32782, 8, null, DoomInfo.ma.VileAttack, MobjState.VileAtk11, 0, 0), // State.VileAtk10
            ...
            new MobjStateDef(270, Sprite.VILE, 16, 5, null, DoomInfo.ma.Pain, MobjState.VileRun1, 0, 0), // State.VilePain2
            new MobjStateDef(271, Sprite.VILE, 16, 7, null, null, MobjState.VileDie2, 0, 0), // State.VileDie1
            new MobjStateDef(272, Sprite.VILE, 17, 7, null, DoomInfo.ma.Scream, MobjState.VileDie3, 0, 0), // State.VileDie2
            new MobjStateDef(273, Sprite.VILE, 18, 7, null, DoomInfo.ma.Fall, MobjState.VileDie4, 0, 0), // State.VileDie3
            ...
            new MobjStateDef(281, Sprite.FIRE, 32768, 2, null, DoomInfo.ma.StartFire, MobjState.Fire2, 0, 0), // State.Fire1
            new MobjStateDef(282, Sprite.FIRE, 32769, 2, null, DoomInfo.ma.Fire, MobjState.Fire3, 0, 0), // State.Fire2
            new MobjStateDef(283, Sprite.FIRE, 32768, 2, null, DoomInfo.ma.Fire, MobjState.Fire4, 0, 0), // State.Fire3
            new MobjStateDef(284, Sprite.FIRE, 32769, 2, null, DoomInfo.ma.Fire, MobjState.Fire5, 0, 0), // State.Fire4
            new MobjStateDef(285, Sprite.FIRE, 32770, 2, null, DoomInfo.ma.FireCrackle, MobjState.Fire6, 0, 0), // State.Fire5
            new MobjStateDef(286, Sprite.FIRE, 32769, 2, null, DoomInfo.ma.Fire, MobjState.Fire7, 0, 0), // State.Fire6
            new MobjStateDef(287, Sprite.FIRE, 32770, 2, null, DoomInfo.ma.Fire, MobjState.Fire8, 0, 0), // State.Fire7
            new MobjStateDef(288, Sprite.FIRE, 32769, 2, null, DoomInfo.ma.Fire, MobjState.Fire9, 0, 0), // State.Fire8
            new MobjStateDef(289, Sprite.FIRE, 32770, 2, null, DoomInfo.ma.Fire, MobjState.Fire10, 0, 0), // State.Fire9
            new MobjStateDef(290, Sprite.FIRE, 32771, 2, null, DoomInfo.ma.Fire, MobjState.Fire11, 0, 0), // State.Fire10
            new MobjStateDef(291, Sprite.FIRE, 32770, 2, null, DoomInfo.ma.Fire, MobjState.Fire12, 0, 0), // State.Fire11
            new MobjStateDef(292, Sprite.FIRE, 32771, 2, null, DoomInfo.ma.Fire, MobjState.Fire13, 0, 0), // State.Fire12
            new MobjStateDef(293, Sprite.FIRE, 32770, 2, null, DoomInfo.ma.Fire, MobjState.Fire14, 0, 0), // State.Fire13
            new MobjStateDef(294, Sprite.FIRE, 32771, 2, null, DoomInfo.ma.Fire, MobjState.Fire15, 0, 0), // State.Fire14
            new MobjStateDef(295, Sprite.FIRE, 32772, 2, null, DoomInfo.ma.Fire, MobjState.Fire16, 0, 0), // State.Fire15
            new MobjStateDef(296, Sprite.FIRE, 32771, 2, null, DoomInfo.ma.Fire, MobjState.Fire17, 0, 0), // State.Fire16
            new MobjStateDef(297, Sprite.FIRE, 32772, 2, null, DoomInfo.ma.Fire, MobjState.Fire18, 0, 0), // State.Fire17
            new MobjStateDef(298, Sprite.FIRE, 32771, 2, null, DoomInfo.ma.Fire, MobjState.Fire19, 0, 0), // State.Fire18
            new MobjStateDef(299, Sprite.FIRE, 32772, 2, null, DoomInfo.ma.FireCrackle, MobjState.Fire20, 0, 0), // State.Fire19
            new MobjStateDef(300, Sprite.FIRE, 32773, 2, null, DoomInfo.ma.Fire, MobjState.Fire21, 0, 0), // State.Fire20
            new MobjStateDef(301, Sprite.FIRE, 32772, 2, null, DoomInfo.ma.Fire, MobjState.Fire22, 0, 0), // State.Fire21
            new MobjStateDef(302, Sprite.FIRE, 32773, 2, null, DoomInfo.ma.Fire, MobjState.Fire23, 0, 0), // State.Fire22
            new MobjStateDef(303, Sprite.FIRE, 32772, 2, null, DoomInfo.ma.Fire, MobjState.Fire24, 0, 0), // State.Fire23
            new MobjStateDef(304, Sprite.FIRE, 32773, 2, null, DoomInfo.ma.Fire, MobjState.Fire25, 0, 0), // State.Fire24
            new MobjStateDef(305, Sprite.FIRE, 32774, 2, null, DoomInfo.ma.Fire, MobjState.Fire26, 0, 0), // State.Fire25
            new MobjStateDef(306, Sprite.FIRE, 32775, 2, null, DoomInfo.ma.Fire, MobjState.Fire27, 0, 0), // State.Fire26
            new MobjStateDef(307, Sprite.FIRE, 32774, 2, null, DoomInfo.ma.Fire, MobjState.Fire28, 0, 0), // State.Fire27
            new MobjStateDef(308, Sprite.FIRE, 32775, 2, null, DoomInfo.ma.Fire, MobjState.Fire29, 0, 0), // State.Fire28
            new MobjStateDef(309, Sprite.FIRE, 32774, 2, null, DoomInfo.ma.Fire, MobjState.Fire30, 0, 0), // State.Fire29
            new MobjStateDef(310, Sprite.FIRE, 32775, 2, null, DoomInfo.ma.Fire, MobjState.Null, 0, 0), // State.Fire30
            ...
            new MobjStateDef(316, Sprite.FATB, 32768, 2, null, DoomInfo.ma.Tracer, MobjState.Tracer2, 0, 0), // State.Tracer
            new MobjStateDef(317, Sprite.FATB, 32769, 2, null, DoomInfo.ma.Tracer, MobjState.Tracer, 0, 0), // State.Tracer2
            ...
            new MobjStateDef(321, Sprite.SKEL, 0, 10, null, DoomInfo.ma.Look, MobjState.SkelStnd2, 0, 0), // State.SkelStnd
            new MobjStateDef(322, Sprite.SKEL, 1, 10, null, DoomInfo.ma.Look, MobjState.SkelStnd, 0, 0), // State.SkelStnd2
            new MobjStateDef(323, Sprite.SKEL, 0, 2, null, DoomInfo.ma.Chase, MobjState.SkelRun2, 0, 0), // State.SkelRun1
            new MobjStateDef(324, Sprite.SKEL, 0, 2, null, DoomInfo.ma.Chase, MobjState.SkelRun3, 0, 0), // State.SkelRun2
            new MobjStateDef(325, Sprite.SKEL, 1, 2, null, DoomInfo.ma.Chase, MobjState.SkelRun4, 0, 0), // State.SkelRun3
            new MobjStateDef(326, Sprite.SKEL, 1, 2, null, DoomInfo.ma.Chase, MobjState.SkelRun5, 0, 0), // State.SkelRun4
            new MobjStateDef(327, Sprite.SKEL, 2, 2, null, DoomInfo.ma.Chase, MobjState.SkelRun6, 0, 0), // State.SkelRun5
            new MobjStateDef(328, Sprite.SKEL, 2, 2, null, DoomInfo.ma.Chase, MobjState.SkelRun7, 0, 0), // State.SkelRun6
            new MobjStateDef(329, Sprite.SKEL, 3, 2, null, DoomInfo.ma.Chase, MobjState.SkelRun8, 0, 0), // State.SkelRun7
            new MobjStateDef(330, Sprite.SKEL, 3, 2, null, DoomInfo.ma.Chase, MobjState.SkelRun9, 0, 0), // State.SkelRun8
            new MobjStateDef(331, Sprite.SKEL, 4, 2, null, DoomInfo.ma.Chase, MobjState.SkelRun10, 0, 0), // State.SkelRun9
            new MobjStateDef(332, Sprite.SKEL, 4, 2, null, DoomInfo.ma.Chase, MobjState.SkelRun11, 0, 0), // State.SkelRun10
            new MobjStateDef(333, Sprite.SKEL, 5, 2, null, DoomInfo.ma.Chase, MobjState.SkelRun12, 0, 0), // State.SkelRun11
            new MobjStateDef(334, Sprite.SKEL, 5, 2, null, DoomInfo.ma.Chase, MobjState.SkelRun1, 0, 0), // State.SkelRun12
            new MobjStateDef(335, Sprite.SKEL, 6, 0, null, DoomInfo.ma.FaceTarget, MobjState.SkelFist2, 0, 0), // State.SkelFist1
            new MobjStateDef(336, Sprite.SKEL, 6, 6, null, DoomInfo.ma.SkelWhoosh, MobjState.SkelFist3, 0, 0), // State.SkelFist2
            new MobjStateDef(337, Sprite.SKEL, 7, 6, null, DoomInfo.ma.FaceTarget, MobjState.SkelFist4, 0, 0), // State.SkelFist3
            new MobjStateDef(338, Sprite.SKEL, 8, 6, null, DoomInfo.ma.SkelFist, MobjState.SkelRun1, 0, 0), // State.SkelFist4
            new MobjStateDef(339, Sprite.SKEL, 32777, 0, null, DoomInfo.ma.FaceTarget, MobjState.SkelMiss2, 0, 0), // State.SkelMiss1
            new MobjStateDef(340, Sprite.SKEL, 32777, 10, null, DoomInfo.ma.FaceTarget, MobjState.SkelMiss3, 0, 0), // State.SkelMiss2
            new MobjStateDef(341, Sprite.SKEL, 10, 10, null, DoomInfo.ma.SkelMissile, MobjState.SkelMiss4, 0, 0), // State.SkelMiss3
            new MobjStateDef(342, Sprite.SKEL, 10, 10, null, DoomInfo.ma.FaceTarget, MobjState.SkelRun1, 0, 0), // State.SkelMiss4
            new MobjStateDef(343, Sprite.SKEL, 11, 5, null, null, MobjState.SkelPain2, 0, 0), // State.SkelPain
            new MobjStateDef(344, Sprite.SKEL, 11, 5, null, DoomInfo.ma.Pain, MobjState.SkelRun1, 0, 0), // State.SkelPain2
            ...
            new MobjStateDef(347, Sprite.SKEL, 13, 7, null, DoomInfo.ma.Scream, MobjState.SkelDie4, 0, 0), // State.SkelDie3
            new MobjStateDef(348, Sprite.SKEL, 14, 7, null, DoomInfo.ma.Fall, MobjState.SkelDie5, 0, 0), // State.SkelDie4
            ...
            new MobjStateDef(362, Sprite.FATT, 0, 15, null, DoomInfo.ma.Look, MobjState.FattStnd2, 0, 0), // State.FattStnd
            new MobjStateDef(363, Sprite.FATT, 1, 15, null, DoomInfo.ma.Look, MobjState.FattStnd, 0, 0), // State.FattStnd2
            new MobjStateDef(364, Sprite.FATT, 0, 4, null, DoomInfo.ma.Chase, MobjState.FattRun2, 0, 0), // State.FattRun1
            new MobjStateDef(365, Sprite.FATT, 0, 4, null, DoomInfo.ma.Chase, MobjState.FattRun3, 0, 0), // State.FattRun2
            new MobjStateDef(366, Sprite.FATT, 1, 4, null, DoomInfo.ma.Chase, MobjState.FattRun4, 0, 0), // State.FattRun3
            new MobjStateDef(367, Sprite.FATT, 1, 4, null, DoomInfo.ma.Chase, MobjState.FattRun5, 0, 0), // State.FattRun4
            new MobjStateDef(368, Sprite.FATT, 2, 4, null, DoomInfo.ma.Chase, MobjState.FattRun6, 0, 0), // State.FattRun5
            new MobjStateDef(369, Sprite.FATT, 2, 4, null, DoomInfo.ma.Chase, MobjState.FattRun7, 0, 0), // State.FattRun6
            new MobjStateDef(370, Sprite.FATT, 3, 4, null, DoomInfo.ma.Chase, MobjState.FattRun8, 0, 0), // State.FattRun7
            new MobjStateDef(371, Sprite.FATT, 3, 4, null, DoomInfo.ma.Chase, MobjState.FattRun9, 0, 0), // State.FattRun8
            new MobjStateDef(372, Sprite.FATT, 4, 4, null, DoomInfo.ma.Chase, MobjState.FattRun10, 0, 0), // State.FattRun9
            new MobjStateDef(373, Sprite.FATT, 4, 4, null, DoomInfo.ma.Chase, MobjState.FattRun11, 0, 0), // State.FattRun10
            new MobjStateDef(374, Sprite.FATT, 5, 4, null, DoomInfo.ma.Chase, MobjState.FattRun12, 0, 0), // State.FattRun11
            new MobjStateDef(375, Sprite.FATT, 5, 4, null, DoomInfo.ma.Chase, MobjState.FattRun1, 0, 0), // State.FattRun12
            new MobjStateDef(376, Sprite.FATT, 6, 20, null, DoomInfo.ma.FatRaise, MobjState.FattAtk2, 0, 0), // State.FattAtk1
            new MobjStateDef(377, Sprite.FATT, 32775, 10, null, DoomInfo.ma.FatAttack1, MobjState.FattAtk3, 0, 0), // State.FattAtk2
            new MobjStateDef(378, Sprite.FATT, 8, 5, null, DoomInfo.ma.FaceTarget, MobjState.FattAtk4, 0, 0), // State.FattAtk3
            new MobjStateDef(379, Sprite.FATT, 6, 5, null, DoomInfo.ma.FaceTarget, MobjState.FattAtk5, 0, 0), // State.FattAtk4
            new MobjStateDef(380, Sprite.FATT, 32775, 10, null, DoomInfo.ma.FatAttack2, MobjState.FattAtk6, 0, 0), // State.FattAtk5
            new MobjStateDef(381, Sprite.FATT, 8, 5, null, DoomInfo.ma.FaceTarget, MobjState.FattAtk7, 0, 0), // State.FattAtk6
            new MobjStateDef(382, Sprite.FATT, 6, 5, null, DoomInfo.ma.FaceTarget, MobjState.FattAtk8, 0, 0), // State.FattAtk7
            new MobjStateDef(383, Sprite.FATT, 32775, 10, null, DoomInfo.ma.FatAttack3, MobjState.FattAtk9, 0, 0), // State.FattAtk8
            new MobjStateDef(384, Sprite.FATT, 8, 5, null, DoomInfo.ma.FaceTarget, MobjState.FattAtk10, 0, 0), // State.FattAtk9
            new MobjStateDef(385, Sprite.FATT, 6, 5, null, DoomInfo.ma.FaceTarget, MobjState.FattRun1, 0, 0), // State.FattAtk10
            new MobjStateDef(386, Sprite.FATT, 9, 3, null, null, MobjState.FattPain2, 0, 0), // State.FattPain
            new MobjStateDef(387, Sprite.FATT, 9, 3, null, DoomInfo.ma.Pain, MobjState.FattRun1, 0, 0), // State.FattPain2
            new MobjStateDef(388, Sprite.FATT, 10, 6, null, null, MobjState.FattDie2, 0, 0), // State.FattDie1
            new MobjStateDef(389, Sprite.FATT, 11, 6, null, DoomInfo.ma.Scream, MobjState.FattDie3, 0, 0), // State.FattDie2
            new MobjStateDef(390, Sprite.FATT, 12, 6, null, DoomInfo.ma.Fall, MobjState.FattDie4, 0, 0), // State.FattDie3
            ...
            new MobjStateDef(397, Sprite.FATT, 19, -1, null, DoomInfo.ma.BossDeath, MobjState.Null, 0, 0), // State.FattDie10
            ...
            new MobjStateDef(406, Sprite.CPOS, 0, 10, null, DoomInfo.ma.Look, MobjState.CposStnd2, 0, 0), // State.CposStnd
            new MobjStateDef(407, Sprite.CPOS, 1, 10, null, DoomInfo.ma.Look, MobjState.CposStnd, 0, 0), // State.CposStnd2
            new MobjStateDef(408, Sprite.CPOS, 0, 3, null, DoomInfo.ma.Chase, MobjState.CposRun2, 0, 0), // State.CposRun1
            new MobjStateDef(409, Sprite.CPOS, 0, 3, null, DoomInfo.ma.Chase, MobjState.CposRun3, 0, 0), // State.CposRun2
            new MobjStateDef(410, Sprite.CPOS, 1, 3, null, DoomInfo.ma.Chase, MobjState.CposRun4, 0, 0), // State.CposRun3
            new MobjStateDef(411, Sprite.CPOS, 1, 3, null, DoomInfo.ma.Chase, MobjState.CposRun5, 0, 0), // State.CposRun4
            new MobjStateDef(412, Sprite.CPOS, 2, 3, null, DoomInfo.ma.Chase, MobjState.CposRun6, 0, 0), // State.CposRun5
            new MobjStateDef(413, Sprite.CPOS, 2, 3, null, DoomInfo.ma.Chase, MobjState.CposRun7, 0, 0), // State.CposRun6
            new MobjStateDef(414, Sprite.CPOS, 3, 3, null, DoomInfo.ma.Chase, MobjState.CposRun8, 0, 0), // State.CposRun7
            new MobjStateDef(415, Sprite.CPOS, 3, 3, null, DoomInfo.ma.Chase, MobjState.CposRun1, 0, 0), // State.CposRun8
            new MobjStateDef(416, Sprite.CPOS, 4, 10, null, DoomInfo.ma.FaceTarget, MobjState.CposAtk2, 0, 0), // State.CposAtk1
            new MobjStateDef(417, Sprite.CPOS, 32773, 4, null, DoomInfo.ma.CPosAttack, MobjState.CposAtk3, 0, 0), // State.CposAtk2
            new MobjStateDef(418, Sprite.CPOS, 32772, 4, null, DoomInfo.ma.CPosAttack, MobjState.CposAtk4, 0, 0), // State.CposAtk3
            new MobjStateDef(419, Sprite.CPOS, 5, 1, null, DoomInfo.ma.CPosRefire, MobjState.CposAtk2, 0, 0), // State.CposAtk4
            new MobjStateDef(420, Sprite.CPOS, 6, 3, null, null, MobjState.CposPain2, 0, 0), // State.CposPain
            new MobjStateDef(421, Sprite.CPOS, 6, 3, null, DoomInfo.ma.Pain, MobjState.CposRun1, 0, 0), // State.CposPain2
            new MobjStateDef(422, Sprite.CPOS, 7, 5, null, null, MobjState.CposDie2, 0, 0), // State.CposDie1
            new MobjStateDef(423, Sprite.CPOS, 8, 5, null, DoomInfo.ma.Scream, MobjState.CposDie3, 0, 0), // State.CposDie2
            new MobjStateDef(424, Sprite.CPOS, 9, 5, null, DoomInfo.ma.Fall, MobjState.CposDie4, 0, 0), // State.CposDie3
            ...
            new MobjStateDef(430, Sprite.CPOS, 15, 5, null, DoomInfo.ma.XScream, MobjState.CposXdie3, 0, 0), // State.CposXdie2
            new MobjStateDef(431, Sprite.CPOS, 16, 5, null, DoomInfo.ma.Fall, MobjState.CposXdie4, 0, 0), // State.CposXdie3
            ...
            new MobjStateDef(442, Sprite.TROO, 0, 10, null, DoomInfo.ma.Look, MobjState.TrooStnd2, 0, 0), // State.TrooStnd
            new MobjStateDef(443, Sprite.TROO, 1, 10, null, DoomInfo.ma.Look, MobjState.TrooStnd, 0, 0), // State.TrooStnd2
            new MobjStateDef(444, Sprite.TROO, 0, 3, null, DoomInfo.ma.Chase, MobjState.TrooRun2, 0, 0), // State.TrooRun1
            new MobjStateDef(445, Sprite.TROO, 0, 3, null, DoomInfo.ma.Chase, MobjState.TrooRun3, 0, 0), // State.TrooRun2
            new MobjStateDef(446, Sprite.TROO, 1, 3, null, DoomInfo.ma.Chase, MobjState.TrooRun4, 0, 0), // State.TrooRun3
            new MobjStateDef(447, Sprite.TROO, 1, 3, null, DoomInfo.ma.Chase, MobjState.TrooRun5, 0, 0), // State.TrooRun4
            new MobjStateDef(448, Sprite.TROO, 2, 3, null, DoomInfo.ma.Chase, MobjState.TrooRun6, 0, 0), // State.TrooRun5
            new MobjStateDef(449, Sprite.TROO, 2, 3, null, DoomInfo.ma.Chase, MobjState.TrooRun7, 0, 0), // State.TrooRun6
            new MobjStateDef(450, Sprite.TROO, 3, 3, null, DoomInfo.ma.Chase, MobjState.TrooRun8, 0, 0), // State.TrooRun7
            new MobjStateDef(451, Sprite.TROO, 3, 3, null, DoomInfo.ma.Chase, MobjState.TrooRun1, 0, 0), // State.TrooRun8
            new MobjStateDef(452, Sprite.TROO, 4, 8, null, DoomInfo.ma.FaceTarget, MobjState.TrooAtk2, 0, 0), // State.TrooAtk1
            new MobjStateDef(453, Sprite.TROO, 5, 8, null, DoomInfo.ma.FaceTarget, MobjState.TrooAtk3, 0, 0), // State.TrooAtk2
            new MobjStateDef(454, Sprite.TROO, 6, 6, null, DoomInfo.ma.TroopAttack, MobjState.TrooRun1, 0, 0), // State.TrooAtk3
            new MobjStateDef(455, Sprite.TROO, 7, 2, null, null, MobjState.TrooPain2, 0, 0), // State.TrooPain
            new MobjStateDef(456, Sprite.TROO, 7, 2, null, DoomInfo.ma.Pain, MobjState.TrooRun1, 0, 0), // State.TrooPain2
            new MobjStateDef(457, Sprite.TROO, 8, 8, null, null, MobjState.TrooDie2, 0, 0), // State.TrooDie1
            new MobjStateDef(458, Sprite.TROO, 9, 8, null, DoomInfo.ma.Scream, MobjState.TrooDie3, 0, 0), // State.TrooDie2
            new MobjStateDef(459, Sprite.TROO, 10, 6, null, null, MobjState.TrooDie4, 0, 0), // State.TrooDie3
            new MobjStateDef(460, Sprite.TROO, 11, 6, null, DoomInfo.ma.Fall, MobjState.TrooDie5, 0, 0), // State.TrooDie4
            ...
            new MobjStateDef(463, Sprite.TROO, 14, 5, null, DoomInfo.ma.XScream, MobjState.TrooXdie3, 0, 0), // State.TrooXdie2
            new MobjStateDef(464, Sprite.TROO, 15, 5, null, null, MobjState.TrooXdie4, 0, 0), // State.TrooXdie3
            new MobjStateDef(465, Sprite.TROO, 16, 5, null, DoomInfo.ma.Fall, MobjState.TrooXdie5, 0, 0), // State.TrooXdie4
            ...
            new MobjStateDef(475, Sprite.SARG, 0, 10, null, DoomInfo.ma.Look, MobjState.SargStnd2, 0, 0), // State.SargStnd
            new MobjStateDef(476, Sprite.SARG, 1, 10, null, DoomInfo.ma.Look, MobjState.SargStnd, 0, 0), // State.SargStnd2
            new MobjStateDef(477, Sprite.SARG, 0, 2, null, DoomInfo.ma.Chase, MobjState.SargRun2, 0, 0), // State.SargRun1
            new MobjStateDef(478, Sprite.SARG, 0, 2, null, DoomInfo.ma.Chase, MobjState.SargRun3, 0, 0), // State.SargRun2
            new MobjStateDef(479, Sprite.SARG, 1, 2, null, DoomInfo.ma.Chase, MobjState.SargRun4, 0, 0), // State.SargRun3
            new MobjStateDef(480, Sprite.SARG, 1, 2, null, DoomInfo.ma.Chase, MobjState.SargRun5, 0, 0), // State.SargRun4
            new MobjStateDef(481, Sprite.SARG, 2, 2, null, DoomInfo.ma.Chase, MobjState.SargRun6, 0, 0), // State.SargRun5
            new MobjStateDef(482, Sprite.SARG, 2, 2, null, DoomInfo.ma.Chase, MobjState.SargRun7, 0, 0), // State.SargRun6
            new MobjStateDef(483, Sprite.SARG, 3, 2, null, DoomInfo.ma.Chase, MobjState.SargRun8, 0, 0), // State.SargRun7
            new MobjStateDef(484, Sprite.SARG, 3, 2, null, DoomInfo.ma.Chase, MobjState.SargRun1, 0, 0), // State.SargRun8
            new MobjStateDef(485, Sprite.SARG, 4, 8, null, DoomInfo.ma.FaceTarget, MobjState.SargAtk2, 0, 0), // State.SargAtk1
            new MobjStateDef(486, Sprite.SARG, 5, 8, null, DoomInfo.ma.FaceTarget, MobjState.SargAtk3, 0, 0), // State.SargAtk2
            new MobjStateDef(487, Sprite.SARG, 6, 8, null, DoomInfo.ma.SargAttack, MobjState.SargRun1, 0, 0), // State.SargAtk3
            new MobjStateDef(488, Sprite.SARG, 7, 2, null, null, MobjState.SargPain2, 0, 0), // State.SargPain
            new MobjStateDef(489, Sprite.SARG, 7, 2, null, DoomInfo.ma.Pain, MobjState.SargRun1, 0, 0), // State.SargPain2
            new MobjStateDef(490, Sprite.SARG, 8, 8, null, null, MobjState.SargDie2, 0, 0), // State.SargDie1
            new MobjStateDef(491, Sprite.SARG, 9, 8, null, DoomInfo.ma.Scream, MobjState.SargDie3, 0, 0), // State.SargDie2
            new MobjStateDef(492, Sprite.SARG, 10, 4, null, null, MobjState.SargDie4, 0, 0), // State.SargDie3
            new MobjStateDef(493, Sprite.SARG, 11, 4, null, DoomInfo.ma.Fall, MobjState.SargDie5, 0, 0), // State.SargDie4
            ...
            new MobjStateDef(502, Sprite.HEAD, 0, 10, null, DoomInfo.ma.Look, MobjState.HeadStnd, 0, 0), // State.HeadStnd
            new MobjStateDef(503, Sprite.HEAD, 0, 3, null, DoomInfo.ma.Chase, MobjState.HeadRun1, 0, 0), // State.HeadRun1
            new MobjStateDef(504, Sprite.HEAD, 1, 5, null, DoomInfo.ma.FaceTarget, MobjState.HeadAtk2, 0, 0), // State.HeadAtk1
            new MobjStateDef(505, Sprite.HEAD, 2, 5, null, DoomInfo.ma.FaceTarget, MobjState.HeadAtk3, 0, 0), // State.HeadAtk2
            new MobjStateDef(506, Sprite.HEAD, 32771, 5, null, DoomInfo.ma.HeadAttack, MobjState.HeadRun1, 0, 0), // State.HeadAtk3
            new MobjStateDef(507, Sprite.HEAD, 4, 3, null, null, MobjState.HeadPain2, 0, 0), // State.HeadPain
            new MobjStateDef(508, Sprite.HEAD, 4, 3, null, DoomInfo.ma.Pain, MobjState.HeadPain3, 0, 0), // State.HeadPain2
            ...
            new MobjStateDef(511, Sprite.HEAD, 7, 8, null, DoomInfo.ma.Scream, MobjState.HeadDie3, 0, 0), // State.HeadDie2
            ...
            new MobjStateDef(514, Sprite.HEAD, 10, 8, null, DoomInfo.ma.Fall, MobjState.HeadDie6, 0, 0), // State.HeadDie5
            ...
            new MobjStateDef(527, Sprite.BOSS, 0, 10, null, DoomInfo.ma.Look, MobjState.BossStnd2, 0, 0), // State.BossStnd
            new MobjStateDef(528, Sprite.BOSS, 1, 10, null, DoomInfo.ma.Look, MobjState.BossStnd, 0, 0), // State.BossStnd2
            new MobjStateDef(529, Sprite.BOSS, 0, 3, null, DoomInfo.ma.Chase, MobjState.BossRun2, 0, 0), // State.BossRun1
            new MobjStateDef(530, Sprite.BOSS, 0, 3, null, DoomInfo.ma.Chase, MobjState.BossRun3, 0, 0), // State.BossRun2
            new MobjStateDef(531, Sprite.BOSS, 1, 3, null, DoomInfo.ma.Chase, MobjState.BossRun4, 0, 0), // State.BossRun3
            new MobjStateDef(532, Sprite.BOSS, 1, 3, null, DoomInfo.ma.Chase, MobjState.BossRun5, 0, 0), // State.BossRun4
            new MobjStateDef(533, Sprite.BOSS, 2, 3, null, DoomInfo.ma.Chase, MobjState.BossRun6, 0, 0), // State.BossRun5
            new MobjStateDef(534, Sprite.BOSS, 2, 3, null, DoomInfo.ma.Chase, MobjState.BossRun7, 0, 0), // State.BossRun6
            new MobjStateDef(535, Sprite.BOSS, 3, 3, null, DoomInfo.ma.Chase, MobjState.BossRun8, 0, 0), // State.BossRun7
            new MobjStateDef(536, Sprite.BOSS, 3, 3, null, DoomInfo.ma.Chase, MobjState.BossRun1, 0, 0), // State.BossRun8
            new MobjStateDef(537, Sprite.BOSS, 4, 8, null, DoomInfo.ma.FaceTarget, MobjState.BossAtk2, 0, 0), // State.BossAtk1
            new MobjStateDef(538, Sprite.BOSS, 5, 8, null, DoomInfo.ma.FaceTarget, MobjState.BossAtk3, 0, 0), // State.BossAtk2
            new MobjStateDef(539, Sprite.BOSS, 6, 8, null, DoomInfo.ma.BruisAttack, MobjState.BossRun1, 0, 0), // State.BossAtk3
            new MobjStateDef(540, Sprite.BOSS, 7, 2, null, null, MobjState.BossPain2, 0, 0), // State.BossPain
            new MobjStateDef(541, Sprite.BOSS, 7, 2, null, DoomInfo.ma.Pain, MobjState.BossRun1, 0, 0), // State.BossPain2
            new MobjStateDef(542, Sprite.BOSS, 8, 8, null, null, MobjState.BossDie2, 0, 0), // State.BossDie1
            new MobjStateDef(543, Sprite.BOSS, 9, 8, null, DoomInfo.ma.Scream, MobjState.BossDie3, 0, 0), // State.BossDie2
            new MobjStateDef(544, Sprite.BOSS, 10, 8, null, null, MobjState.BossDie4, 0, 0), // State.BossDie3
            new MobjStateDef(545, Sprite.BOSS, 11, 8, null, DoomInfo.ma.Fall, MobjState.BossDie5, 0, 0), // State.BossDie4
            ...
            new MobjStateDef(548, Sprite.BOSS, 14, -1, null, DoomInfo.ma.BossDeath, MobjState.Null, 0, 0), // State.BossDie7
            ...
            new MobjStateDef(556, Sprite.BOS2, 0, 10, null, DoomInfo.ma.Look, MobjState.Bos2Stnd2, 0, 0), // State.Bos2Stnd
            new MobjStateDef(557, Sprite.BOS2, 1, 10, null, DoomInfo.ma.Look, MobjState.Bos2Stnd, 0, 0), // State.Bos2Stnd2
            new MobjStateDef(558, Sprite.BOS2, 0, 3, null, DoomInfo.ma.Chase, MobjState.Bos2Run2, 0, 0), // State.Bos2Run1
            new MobjStateDef(559, Sprite.BOS2, 0, 3, null, DoomInfo.ma.Chase, MobjState.Bos2Run3, 0, 0), // State.Bos2Run2
            new MobjStateDef(560, Sprite.BOS2, 1, 3, null, DoomInfo.ma.Chase, MobjState.Bos2Run4, 0, 0), // State.Bos2Run3
            new MobjStateDef(561, Sprite.BOS2, 1, 3, null, DoomInfo.ma.Chase, MobjState.Bos2Run5, 0, 0), // State.Bos2Run4
            new MobjStateDef(562, Sprite.BOS2, 2, 3, null, DoomInfo.ma.Chase, MobjState.Bos2Run6, 0, 0), // State.Bos2Run5
            new MobjStateDef(563, Sprite.BOS2, 2, 3, null, DoomInfo.ma.Chase, MobjState.Bos2Run7, 0, 0), // State.Bos2Run6
            new MobjStateDef(564, Sprite.BOS2, 3, 3, null, DoomInfo.ma.Chase, MobjState.Bos2Run8, 0, 0), // State.Bos2Run7
            new MobjStateDef(565, Sprite.BOS2, 3, 3, null, DoomInfo.ma.Chase, MobjState.Bos2Run1, 0, 0), // State.Bos2Run8
            new MobjStateDef(566, Sprite.BOS2, 4, 8, null, DoomInfo.ma.FaceTarget, MobjState.Bos2Atk2, 0, 0), // State.Bos2Atk1
            new MobjStateDef(567, Sprite.BOS2, 5, 8, null, DoomInfo.ma.FaceTarget, MobjState.Bos2Atk3, 0, 0), // State.Bos2Atk2
            new MobjStateDef(568, Sprite.BOS2, 6, 8, null, DoomInfo.ma.BruisAttack, MobjState.Bos2Run1, 0, 0), // State.Bos2Atk3
            new MobjStateDef(569, Sprite.BOS2, 7, 2, null, null, MobjState.Bos2Pain2, 0, 0), // State.Bos2Pain
            new MobjStateDef(570, Sprite.BOS2, 7, 2, null, DoomInfo.ma.Pain, MobjState.Bos2Run1, 0, 0), // State.Bos2Pain2
            new MobjStateDef(571, Sprite.BOS2, 8, 8, null, null, MobjState.Bos2Die2, 0, 0), // State.Bos2Die1
            new MobjStateDef(572, Sprite.BOS2, 9, 8, null, DoomInfo.ma.Scream, MobjState.Bos2Die3, 0, 0), // State.Bos2Die2
            new MobjStateDef(573, Sprite.BOS2, 10, 8, null, null, MobjState.Bos2Die4, 0, 0), // State.Bos2Die3
            new MobjStateDef(574, Sprite.BOS2, 11, 8, null, DoomInfo.ma.Fall, MobjState.Bos2Die5, 0, 0), // State.Bos2Die4
            ...
            new MobjStateDef(585, Sprite.SKUL, 32768, 10, null, DoomInfo.ma.Look, MobjState.SkullStnd2, 0, 0), // State.SkullStnd
            new MobjStateDef(586, Sprite.SKUL, 32769, 10, null, DoomInfo.ma.Look, MobjState.SkullStnd, 0, 0), // State.SkullStnd2
            new MobjStateDef(587, Sprite.SKUL, 32768, 6, null, DoomInfo.ma.Chase, MobjState.SkullRun2, 0, 0), // State.SkullRun1
            new MobjStateDef(588, Sprite.SKUL, 32769, 6, null, DoomInfo.ma.Chase, MobjState.SkullRun1, 0, 0), // State.SkullRun2
            new MobjStateDef(589, Sprite.SKUL, 32770, 10, null, DoomInfo.ma.FaceTarget, MobjState.SkullAtk2, 0, 0), // State.SkullAtk1
            new MobjStateDef(590, Sprite.SKUL, 32771, 4, null, DoomInfo.ma.SkullAttack, MobjState.SkullAtk3, 0, 0), // State.SkullAtk2
            ...
            new MobjStateDef(594, Sprite.SKUL, 32772, 3, null, DoomInfo.ma.Pain, MobjState.SkullRun1, 0, 0), // State.SkullPain2
            new MobjStateDef(595, Sprite.SKUL, 32773, 6, null, null, MobjState.SkullDie2, 0, 0), // State.SkullDie1
            new MobjStateDef(596, Sprite.SKUL, 32774, 6, null, DoomInfo.ma.Scream, MobjState.SkullDie3, 0, 0), // State.SkullDie2
            new MobjStateDef(597, Sprite.SKUL, 32775, 6, null, null, MobjState.SkullDie4, 0, 0), // State.SkullDie3
            new MobjStateDef(598, Sprite.SKUL, 32776, 6, null, DoomInfo.ma.Fall, MobjState.SkullDie5, 0, 0), // State.SkullDie4
            ...
            new MobjStateDef(601, Sprite.SPID, 0, 10, null, DoomInfo.ma.Look, MobjState.SpidStnd2, 0, 0), // State.SpidStnd
            new MobjStateDef(602, Sprite.SPID, 1, 10, null, DoomInfo.ma.Look, MobjState.SpidStnd, 0, 0), // State.SpidStnd2
            new MobjStateDef(603, Sprite.SPID, 0, 3, null, DoomInfo.ma.Metal, MobjState.SpidRun2, 0, 0), // State.SpidRun1
            new MobjStateDef(604, Sprite.SPID, 0, 3, null, DoomInfo.ma.Chase, MobjState.SpidRun3, 0, 0), // State.SpidRun2
            new MobjStateDef(605, Sprite.SPID, 1, 3, null, DoomInfo.ma.Chase, MobjState.SpidRun4, 0, 0), // State.SpidRun3
            new MobjStateDef(606, Sprite.SPID, 1, 3, null, DoomInfo.ma.Chase, MobjState.SpidRun5, 0, 0), // State.SpidRun4
            new MobjStateDef(607, Sprite.SPID, 2, 3, null, DoomInfo.ma.Metal, MobjState.SpidRun6, 0, 0), // State.SpidRun5
            new MobjStateDef(608, Sprite.SPID, 2, 3, null, DoomInfo.ma.Chase, MobjState.SpidRun7, 0, 0), // State.SpidRun6
            new MobjStateDef(609, Sprite.SPID, 3, 3, null, DoomInfo.ma.Chase, MobjState.SpidRun8, 0, 0), // State.SpidRun7
            new MobjStateDef(610, Sprite.SPID, 3, 3, null, DoomInfo.ma.Chase, MobjState.SpidRun9, 0, 0), // State.SpidRun8
            new MobjStateDef(611, Sprite.SPID, 4, 3, null, DoomInfo.ma.Metal, MobjState.SpidRun10, 0, 0), // State.SpidRun9
            new MobjStateDef(612, Sprite.SPID, 4, 3, null, DoomInfo.ma.Chase, MobjState.SpidRun11, 0, 0), // State.SpidRun10
            new MobjStateDef(613, Sprite.SPID, 5, 3, null, DoomInfo.ma.Chase, MobjState.SpidRun12, 0, 0), // State.SpidRun11
            new MobjStateDef(614, Sprite.SPID, 5, 3, null, DoomInfo.ma.Chase, MobjState.SpidRun1, 0, 0), // State.SpidRun12
            new MobjStateDef(615, Sprite.SPID, 32768, 20, null, DoomInfo.ma.FaceTarget, MobjState.SpidAtk2, 0, 0), // State.SpidAtk1
            new MobjStateDef(616, Sprite.SPID, 32774, 4, null, DoomInfo.ma.SPosAttack, MobjState.SpidAtk3, 0, 0), // State.SpidAtk2
            new MobjStateDef(617, Sprite.SPID, 32775, 4, null, DoomInfo.ma.SPosAttack, MobjState.SpidAtk4, 0, 0), // State.SpidAtk3
            new MobjStateDef(618, Sprite.SPID, 32775, 1, null, DoomInfo.ma.SpidRefire, MobjState.SpidAtk2, 0, 0), // State.SpidAtk4
            new MobjStateDef(619, Sprite.SPID, 8, 3, null, null, MobjState.SpidPain2, 0, 0), // State.SpidPain
            new MobjStateDef(620, Sprite.SPID, 8, 3, null, DoomInfo.ma.Pain, MobjState.SpidRun1, 0, 0), // State.SpidPain2
            new MobjStateDef(621, Sprite.SPID, 9, 20, null, DoomInfo.ma.Scream, MobjState.SpidDie2, 0, 0), // State.SpidDie1
            new MobjStateDef(622, Sprite.SPID, 10, 10, null, DoomInfo.ma.Fall, MobjState.SpidDie3, 0, 0), // State.SpidDie2
            ...
            new MobjStateDef(631, Sprite.SPID, 18, -1, null, DoomInfo.ma.BossDeath, MobjState.Null, 0, 0), // State.SpidDie11
            new MobjStateDef(632, Sprite.BSPI, 0, 10, null, DoomInfo.ma.Look, MobjState.BspiStnd2, 0, 0), // State.BspiStnd
            new MobjStateDef(633, Sprite.BSPI, 1, 10, null, DoomInfo.ma.Look, MobjState.BspiStnd, 0, 0), // State.BspiStnd2
            new MobjStateDef(634, Sprite.BSPI, 0, 20, null, null, MobjState.BspiRun1, 0, 0), // State.BspiSight
            new MobjStateDef(635, Sprite.BSPI, 0, 3, null, DoomInfo.ma.BabyMetal, MobjState.BspiRun2, 0, 0), // State.BspiRun1
            new MobjStateDef(636, Sprite.BSPI, 0, 3, null, DoomInfo.ma.Chase, MobjState.BspiRun3, 0, 0), // State.BspiRun2
            new MobjStateDef(637, Sprite.BSPI, 1, 3, null, DoomInfo.ma.Chase, MobjState.BspiRun4, 0, 0), // State.BspiRun3
            new MobjStateDef(638, Sprite.BSPI, 1, 3, null, DoomInfo.ma.Chase, MobjState.BspiRun5, 0, 0), // State.BspiRun4
            new MobjStateDef(639, Sprite.BSPI, 2, 3, null, DoomInfo.ma.Chase, MobjState.BspiRun6, 0, 0), // State.BspiRun5
            new MobjStateDef(640, Sprite.BSPI, 2, 3, null, DoomInfo.ma.Chase, MobjState.BspiRun7, 0, 0), // State.BspiRun6
            new MobjStateDef(641, Sprite.BSPI, 3, 3, null, DoomInfo.ma.BabyMetal, MobjState.BspiRun8, 0, 0), // State.BspiRun7
            new MobjStateDef(642, Sprite.BSPI, 3, 3, null, DoomInfo.ma.Chase, MobjState.BspiRun9, 0, 0), // State.BspiRun8
            new MobjStateDef(643, Sprite.BSPI, 4, 3, null, DoomInfo.ma.Chase, MobjState.BspiRun10, 0, 0), // State.BspiRun9
            new MobjStateDef(644, Sprite.BSPI, 4, 3, null, DoomInfo.ma.Chase, MobjState.BspiRun11, 0, 0), // State.BspiRun10
            new MobjStateDef(645, Sprite.BSPI, 5, 3, null, DoomInfo.ma.Chase, MobjState.BspiRun12, 0, 0), // State.BspiRun11
            new MobjStateDef(646, Sprite.BSPI, 5, 3, null, DoomInfo.ma.Chase, MobjState.BspiRun1, 0, 0), // State.BspiRun12
            new MobjStateDef(647, Sprite.BSPI, 32768, 20, null, DoomInfo.ma.FaceTarget, MobjState.BspiAtk2, 0, 0), // State.BspiAtk1
            new MobjStateDef(648, Sprite.BSPI, 32774, 4, null, DoomInfo.ma.BspiAttack, MobjState.BspiAtk3, 0, 0), // State.BspiAtk2
            new MobjStateDef(649, Sprite.BSPI, 32775, 4, null, null, MobjState.BspiAtk4, 0, 0), // State.BspiAtk3
            new MobjStateDef(650, Sprite.BSPI, 32775, 1, null, DoomInfo.ma.SpidRefire, MobjState.BspiAtk2, 0, 0), // State.BspiAtk4
            new MobjStateDef(651, Sprite.BSPI, 8, 3, null, null, MobjState.BspiPain2, 0, 0), // State.BspiPain
            new MobjStateDef(652, Sprite.BSPI, 8, 3, null, DoomInfo.ma.Pain, MobjState.BspiRun1, 0, 0), // State.BspiPain2
            new MobjStateDef(653, Sprite.BSPI, 9, 20, null, DoomInfo.ma.Scream, MobjState.BspiDie2, 0, 0), // State.BspiDie1
            new MobjStateDef(654, Sprite.BSPI, 10, 7, null, DoomInfo.ma.Fall, MobjState.BspiDie3, 0, 0), // State.BspiDie2
            ...
            new MobjStateDef(659, Sprite.BSPI, 15, -1, null, DoomInfo.ma.BossDeath, MobjState.Null, 0, 0), // State.BspiDie7
            ...
            new MobjStateDef(674, Sprite.CYBR, 0, 10, null, DoomInfo.ma.Look, MobjState.CyberStnd2, 0, 0), // State.CyberStnd
            new MobjStateDef(675, Sprite.CYBR, 1, 10, null, DoomInfo.ma.Look, MobjState.CyberStnd, 0, 0), // State.CyberStnd2
            new MobjStateDef(676, Sprite.CYBR, 0, 3, null, DoomInfo.ma.Hoof, MobjState.CyberRun2, 0, 0), // State.CyberRun1
            new MobjStateDef(677, Sprite.CYBR, 0, 3, null, DoomInfo.ma.Chase, MobjState.CyberRun3, 0, 0), // State.CyberRun2
            new MobjStateDef(678, Sprite.CYBR, 1, 3, null, DoomInfo.ma.Chase, MobjState.CyberRun4, 0, 0), // State.CyberRun3
            new MobjStateDef(679, Sprite.CYBR, 1, 3, null, DoomInfo.ma.Chase, MobjState.CyberRun5, 0, 0), // State.CyberRun4
            new MobjStateDef(680, Sprite.CYBR, 2, 3, null, DoomInfo.ma.Chase, MobjState.CyberRun6, 0, 0), // State.CyberRun5
            new MobjStateDef(681, Sprite.CYBR, 2, 3, null, DoomInfo.ma.Chase, MobjState.CyberRun7, 0, 0), // State.CyberRun6
            new MobjStateDef(682, Sprite.CYBR, 3, 3, null, DoomInfo.ma.Metal, MobjState.CyberRun8, 0, 0), // State.CyberRun7
            new MobjStateDef(683, Sprite.CYBR, 3, 3, null, DoomInfo.ma.Chase, MobjState.CyberRun1, 0, 0), // State.CyberRun8
            new MobjStateDef(684, Sprite.CYBR, 4, 6, null, DoomInfo.ma.FaceTarget, MobjState.CyberAtk2, 0, 0), // State.CyberAtk1
            new MobjStateDef(685, Sprite.CYBR, 5, 12, null, DoomInfo.ma.CyberAttack, MobjState.CyberAtk3, 0, 0), // State.CyberAtk2
            new MobjStateDef(686, Sprite.CYBR, 4, 12, null, DoomInfo.ma.FaceTarget, MobjState.CyberAtk4, 0, 0), // State.CyberAtk3
            new MobjStateDef(687, Sprite.CYBR, 5, 12, null, DoomInfo.ma.CyberAttack, MobjState.CyberAtk5, 0, 0), // State.CyberAtk4
            new MobjStateDef(688, Sprite.CYBR, 4, 12, null, DoomInfo.ma.FaceTarget, MobjState.CyberAtk6, 0, 0), // State.CyberAtk5
            new MobjStateDef(689, Sprite.CYBR, 5, 12, null, DoomInfo.ma.CyberAttack, MobjState.CyberRun1, 0, 0), // State.CyberAtk6
            new MobjStateDef(690, Sprite.CYBR, 6, 10, null, DoomInfo.ma.Pain, MobjState.CyberRun1, 0, 0), // State.CyberPain
            new MobjStateDef(691, Sprite.CYBR, 7, 10, null, null, MobjState.CyberDie2, 0, 0), // State.CyberDie1
            new MobjStateDef(692, Sprite.CYBR, 8, 10, null, DoomInfo.ma.Scream, MobjState.CyberDie3, 0, 0), // State.CyberDie2
            ...
            new MobjStateDef(696, Sprite.CYBR, 12, 10, null, DoomInfo.ma.Fall, MobjState.CyberDie7, 0, 0), // State.CyberDie6
            ...
            new MobjStateDef(700, Sprite.CYBR, 15, -1, null, DoomInfo.ma.BossDeath, MobjState.Null, 0, 0), // State.CyberDie10
            new MobjStateDef(701, Sprite.PAIN, 0, 10, null, DoomInfo.ma.Look, MobjState.PainStnd, 0, 0), // State.PainStnd
            new MobjStateDef(702, Sprite.PAIN, 0, 3, null, DoomInfo.ma.Chase, MobjState.PainRun2, 0, 0), // State.PainRun1
            new MobjStateDef(703, Sprite.PAIN, 0, 3, null, DoomInfo.ma.Chase, MobjState.PainRun3, 0, 0), // State.PainRun2
            new MobjStateDef(704, Sprite.PAIN, 1, 3, null, DoomInfo.ma.Chase, MobjState.PainRun4, 0, 0), // State.PainRun3
            new MobjStateDef(705, Sprite.PAIN, 1, 3, null, DoomInfo.ma.Chase, MobjState.PainRun5, 0, 0), // State.PainRun4
            new MobjStateDef(706, Sprite.PAIN, 2, 3, null, DoomInfo.ma.Chase, MobjState.PainRun6, 0, 0), // State.PainRun5
            new MobjStateDef(707, Sprite.PAIN, 2, 3, null, DoomInfo.ma.Chase, MobjState.PainRun1, 0, 0), // State.PainRun6
            new MobjStateDef(708, Sprite.PAIN, 3, 5, null, DoomInfo.ma.FaceTarget, MobjState.PainAtk2, 0, 0), // State.PainAtk1
            new MobjStateDef(709, Sprite.PAIN, 4, 5, null, DoomInfo.ma.FaceTarget, MobjState.PainAtk3, 0, 0), // State.PainAtk2
            new MobjStateDef(710, Sprite.PAIN, 32773, 5, null, DoomInfo.ma.FaceTarget, MobjState.PainAtk4, 0, 0), // State.PainAtk3
            new MobjStateDef(711, Sprite.PAIN, 32773, 0, null, DoomInfo.ma.PainAttack, MobjState.PainRun1, 0, 0), // State.PainAtk4
            new MobjStateDef(712, Sprite.PAIN, 6, 6, null, null, MobjState.PainPain2, 0, 0), // State.PainPain
            new MobjStateDef(713, Sprite.PAIN, 6, 6, null, DoomInfo.ma.Pain, MobjState.PainRun1, 0, 0), // State.PainPain2
            new MobjStateDef(714, Sprite.PAIN, 32775, 8, null, null, MobjState.PainDie2, 0, 0), // State.PainDie1
            new MobjStateDef(715, Sprite.PAIN, 32776, 8, null, DoomInfo.ma.Scream, MobjState.PainDie3, 0, 0), // State.PainDie2
            ...
            new MobjStateDef(718, Sprite.PAIN, 32779, 8, null, DoomInfo.ma.PainDie, MobjState.PainDie6, 0, 0), // State.PainDie5
            ...
            new MobjStateDef(726, Sprite.SSWV, 0, 10, null, DoomInfo.ma.Look, MobjState.SswvStnd2, 0, 0), // State.SswvStnd
            new MobjStateDef(727, Sprite.SSWV, 1, 10, null, DoomInfo.ma.Look, MobjState.SswvStnd, 0, 0), // State.SswvStnd2
            new MobjStateDef(728, Sprite.SSWV, 0, 3, null, DoomInfo.ma.Chase, MobjState.SswvRun2, 0, 0), // State.SswvRun1
            new MobjStateDef(729, Sprite.SSWV, 0, 3, null, DoomInfo.ma.Chase, MobjState.SswvRun3, 0, 0), // State.SswvRun2
            new MobjStateDef(730, Sprite.SSWV, 1, 3, null, DoomInfo.ma.Chase, MobjState.SswvRun4, 0, 0), // State.SswvRun3
            new MobjStateDef(731, Sprite.SSWV, 1, 3, null, DoomInfo.ma.Chase, MobjState.SswvRun5, 0, 0), // State.SswvRun4
            new MobjStateDef(732, Sprite.SSWV, 2, 3, null, DoomInfo.ma.Chase, MobjState.SswvRun6, 0, 0), // State.SswvRun5
            new MobjStateDef(733, Sprite.SSWV, 2, 3, null, DoomInfo.ma.Chase, MobjState.SswvRun7, 0, 0), // State.SswvRun6
            new MobjStateDef(734, Sprite.SSWV, 3, 3, null, DoomInfo.ma.Chase, MobjState.SswvRun8, 0, 0), // State.SswvRun7
            new MobjStateDef(735, Sprite.SSWV, 3, 3, null, DoomInfo.ma.Chase, MobjState.SswvRun1, 0, 0), // State.SswvRun8
            new MobjStateDef(736, Sprite.SSWV, 4, 10, null, DoomInfo.ma.FaceTarget, MobjState.SswvAtk2, 0, 0), // State.SswvAtk1
            new MobjStateDef(737, Sprite.SSWV, 5, 10, null, DoomInfo.ma.FaceTarget, MobjState.SswvAtk3, 0, 0), // State.SswvAtk2
            new MobjStateDef(738, Sprite.SSWV, 32774, 4, null, DoomInfo.ma.CPosAttack, MobjState.SswvAtk4, 0, 0), // State.SswvAtk3
            new MobjStateDef(739, Sprite.SSWV, 5, 6, null, DoomInfo.ma.FaceTarget, MobjState.SswvAtk5, 0, 0), // State.SswvAtk4
            new MobjStateDef(740, Sprite.SSWV, 32774, 4, null, DoomInfo.ma.CPosAttack, MobjState.SswvAtk6, 0, 0), // State.SswvAtk5
            new MobjStateDef(741, Sprite.SSWV, 5, 1, null, DoomInfo.ma.CPosRefire, MobjState.SswvAtk2, 0, 0), // State.SswvAtk6
            new MobjStateDef(742, Sprite.SSWV, 7, 3, null, null, MobjState.SswvPain2, 0, 0), // State.SswvPain
            new MobjStateDef(743, Sprite.SSWV, 7, 3, null, DoomInfo.ma.Pain, MobjState.SswvRun1, 0, 0), // State.SswvPain2
            new MobjStateDef(744, Sprite.SSWV, 8, 5, null, null, MobjState.SswvDie2, 0, 0), // State.SswvDie1
            new MobjStateDef(745, Sprite.SSWV, 9, 5, null, DoomInfo.ma.Scream, MobjState.SswvDie3, 0, 0), // State.SswvDie2
            new MobjStateDef(746, Sprite.SSWV, 10, 5, null, DoomInfo.ma.Fall, MobjState.SswvDie4, 0, 0), // State.SswvDie3
            ...
            new MobjStateDef(750, Sprite.SSWV, 14, 5, null, DoomInfo.ma.XScream, MobjState.SswvXdie3, 0, 0), // State.SswvXdie2
            new MobjStateDef(751, Sprite.SSWV, 15, 5, null, DoomInfo.ma.Fall, MobjState.SswvXdie4, 0, 0), // State.SswvXdie3
            ...
            new MobjStateDef(766, Sprite.KEEN, 2, 6, null, DoomInfo.ma.Scream, MobjState.Commkeen4, 0, 0), // State.Commkeen3
            ...
            new MobjStateDef(774, Sprite.KEEN, 10, 6, null, DoomInfo.ma.KeenDie, MobjState.Commkeen12, 0, 0), // State.Commkeen11
            ...
            new MobjStateDef(777, Sprite.KEEN, 12, 8, null, DoomInfo.ma.Pain, MobjState.Keenstnd, 0, 0), // State.Keenpain2
            new MobjStateDef(778, Sprite.BBRN, 0, -1, null, null, MobjState.Null, 0, 0), // State.Brain
            new MobjStateDef(779, Sprite.BBRN, 1, 36, null, DoomInfo.ma.BrainPain, MobjState.Brain, 0, 0), // State.BrainPain
            new MobjStateDef(780, Sprite.BBRN, 0, 100, null, DoomInfo.ma.BrainScream, MobjState.BrainDie2, 0, 0), // State.BrainDie1
            ...
            new MobjStateDef(783, Sprite.BBRN, 0, -1, null, DoomInfo.ma.BrainDie, MobjState.Null, 0, 0), // State.BrainDie4
            new MobjStateDef(784, Sprite.SSWV, 0, 10, null, DoomInfo.ma.Look, MobjState.Braineye, 0, 0), // State.Braineye
            new MobjStateDef(785, Sprite.SSWV, 0, 181, null, DoomInfo.ma.BrainAwake, MobjState.Braineye1, 0, 0), // State.Braineyesee
            new MobjStateDef(786, Sprite.SSWV, 0, 150, null, DoomInfo.ma.BrainSpit, MobjState.Braineye1, 0, 0), // State.Braineye1
            new MobjStateDef(787, Sprite.BOSF, 32768, 3, null, DoomInfo.ma.SpawnSound, MobjState.Spawn2, 0, 0), // State.Spawn1
            new MobjStateDef(788, Sprite.BOSF, 32769, 3, null, DoomInfo.ma.SpawnFly, MobjState.Spawn3, 0, 0), // State.Spawn2
            new MobjStateDef(789, Sprite.BOSF, 32770, 3, null, DoomInfo.ma.SpawnFly, MobjState.Spawn4, 0, 0), // State.Spawn3
            new MobjStateDef(790, Sprite.BOSF, 32771, 3, null, DoomInfo.ma.SpawnFly, MobjState.Spawn1, 0, 0), // State.Spawn4
            new MobjStateDef(791, Sprite.FIRE, 32768, 4, null, DoomInfo.ma.Fire, MobjState.Spawnfire2, 0, 0), // State.Spawnfire1
            new MobjStateDef(792, Sprite.FIRE, 32769, 4, null, DoomInfo.ma.Fire, MobjState.Spawnfire3, 0, 0), // State.Spawnfire2
            new MobjStateDef(793, Sprite.FIRE, 32770, 4, null, DoomInfo.ma.Fire, MobjState.Spawnfire4, 0, 0), // State.Spawnfire3
            new MobjStateDef(794, Sprite.FIRE, 32771, 4, null, DoomInfo.ma.Fire, MobjState.Spawnfire5, 0, 0), // State.Spawnfire4
            new MobjStateDef(795, Sprite.FIRE, 32772, 4, null, DoomInfo.ma.Fire, MobjState.Spawnfire6, 0, 0), // State.Spawnfire5
            new MobjStateDef(796, Sprite.FIRE, 32773, 4, null, DoomInfo.ma.Fire, MobjState.Spawnfire7, 0, 0), // State.Spawnfire6
            new MobjStateDef(797, Sprite.FIRE, 32774, 4, null, DoomInfo.ma.Fire, MobjState.Spawnfire8, 0, 0), // State.Spawnfire7
            new MobjStateDef(798, Sprite.FIRE, 32775, 4, null, DoomInfo.ma.Fire, MobjState.Null, 0, 0), // State.Spawnfire8
            ...
            new MobjStateDef(801, Sprite.MISL, 32771, 10, null, DoomInfo.ma.BrainExplode, MobjState.Null, 0, 0), // State.Brainexplode3
            ...
            new MobjStateDef(809, Sprite.BEXP, 32769, 5, null, DoomInfo.ma.Scream, MobjState.Bexp3, 0, 0), // State.Bexp2
            new MobjStateDef(810, Sprite.BEXP, 32770, 5, null, null, MobjState.Bexp4, 0, 0), // State.Bexp3
            new MobjStateDef(811, Sprite.BEXP, 32771, 10, null, DoomInfo.ma.Explode, MobjState.Bexp5, 0, 0), // State.Bexp4
