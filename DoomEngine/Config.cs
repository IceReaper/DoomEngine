...
namespace DoomEngine
{
	...
	public sealed class Config
	{
		...
		public Config(IPlatform platform)
		{
			...
			this.key_strafeleft = new KeyBinding(new DoomKey[] {DoomKey.A});
			this.key_straferight = new KeyBinding(new DoomKey[] {DoomKey.D});
			this.key_turnleft = new KeyBinding(new DoomKey[] {DoomKey.Left});
			this.key_turnright = new KeyBinding(new DoomKey[] {DoomKey.Right});
			this.key_fire = new KeyBinding(new DoomKey[] {DoomKey.LControl, DoomKey.RControl}, new DoomMouseButton[] {DoomMouseButton.Mouse1});
			this.key_use = new KeyBinding(new DoomKey[] {DoomKey.Space}, new DoomMouseButton[] {DoomMouseButton.Mouse2});
			this.key_run = new KeyBinding(new DoomKey[] {DoomKey.LShift, DoomKey.RShift});
			this.key_strafe = new KeyBinding(new DoomKey[] {DoomKey.LAlt, DoomKey.RAlt});
